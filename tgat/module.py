...
class TGAN(torch.nn.Module):
    def __init__(self, ngh_finder, n_feat, e_feat, n_feat_freeze=True,
        ...
        self.node_raw_embed = torch.nn.Embedding.from_pretrained(self.n_feat_th, padding_idx=0, freeze=n_feat_freeze)
